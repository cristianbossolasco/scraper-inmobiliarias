...
from properties.scrapers.pending_sources import FincasScraper, GuarnieriScraper, normalize_argencasas_address
...
INPUT_XLSX = ROOT / "tmp" / "curacion_zonas_pendientes_2026-06-27_feedback.xlsx"
OUTPUT_XLSX = ROOT / "tmp" / "curacion_zonas_pendientes_2026-06-27_feedback_iter2.xlsx"
BACKUP_PATH = ROOT / "tmp" / "db.sqlite3.backup_curacion_feedback_20260627_iter2"
DB_PATH = ROOT / "db.sqlite3"
SCRIPT_TAG = "curacion_feedback_20260627_iter2"
...
REJECTED_REMOVE_IDS = {332, 334, 335, 336, 3701}
SAMPLE_IDS = sorted(APPROVED_IDS | REJECTED_REMOVE_IDS)

DIRECT_FIXES = {
    1876: {"address": "Vicente Camargo 2900", "locality": "Villa Tesei", "geocode": True},
    3181: {"address": "Virriato Unia 2412", "locality": "Hurlingham", "geocode": True},
    3342: {"address": "Dolores de Huici 3194", "locality": "William C. Morris", "geocode": True},
    3385: {"address": "Dr. Delfor Diaz 2600", "locality": "William C. Morris", "geocode": True},
    3399: {"address": "Basilio Delleva 1500", "locality": "Hurlingham", "geocode": True},
    3425: {"address": "Gral. Francisco Miranda 1500", "locality": "Hurlingham", "geocode": True},
    3508: {"address": "Altolaguirre 100", "locality": "Hurlingham", "geocode": True, "note": "fallback aprobado para Altolaguirre y Eva Peron"},
    3669: {"address": "Jose de Minoguye 2400", "locality": "William C. Morris", "geocode": True},
    3713: {"address": "Av. Rosas Castillo 2400", "locality": "Hurlingham", "geocode": True},
    3743: {"address": "Bombero Celiz 200", "locality": "Villa Tesei", "geocode": True},
    5105: {"address": "Gral. Toribio de Luzuriaga 1700", "locality": "Hurlingham", "geocode": True},
}
...
SOURCE_DELAYS = {"argencasas": 2, "becerra": 3, "guarnieri": 3, "fincas": 3, "remax-datawork": 5, "miglierini": 2}
FETCH_STATE = {}
...
def generate_excel(reviewed_notes):
    ...
    table = Table(displayName="PendientesFeedback20260627Iter2", ref=ws.dimensions)
...
def apply_feedback(apply):
    ...
    if args_apply_blocked := (
        apply
        and (
            summary["unexpected_approved"]
            or summary["unexpected_rejected"]
            or summary["missing_expected_approved"]
