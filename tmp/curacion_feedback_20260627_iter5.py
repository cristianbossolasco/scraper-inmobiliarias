...
INPUT_XLSX = ROOT / "tmp" / "curacion_zonas_pendientes_2026-06-27_feedback_iter4.xlsx"
OUTPUT_XLSX = ROOT / "tmp" / "curacion_zonas_pendientes_2026-06-27_feedback_iter5.xlsx"
BACKUP_PATH = ROOT / "tmp" / "db.sqlite3.backup_curacion_feedback_20260627_iter5"
DB_PATH = ROOT / "db.sqlite3"
SCRIPT_TAG = "curacion_feedback_20260627_iter5"
...
REJECTED_REMOVE_IDS = {5419, 5480}
NO_ACTION_IDS = set()
MAP_ONLY_IDS = {5327, 5423}
...
DIRECT_FIXES = {
    5703: {"address": "Pablo Pizzurno 1035", "locality": "Hurlingham", "geocode": True},
    5705: {"address": "Tte. Gral. Julio Argentino Roca 1650", "locality": "Hurlingham", "geocode": True},
}
...
def generate_excel(reviewed_notes):
    ...
    table = Table(displayName="PendientesFeedback20260627Iter5", ref=ws.dimensions)
